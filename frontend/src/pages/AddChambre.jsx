...
function Sidebar() {
  return (
    <aside className="w-56 flex-shrink-0 flex flex-col" style={{ background: "#1a1d2e", minHeight: "100vh" }}>
      {/* Logo */}
      <div className="flex items-center gap-3 px-4 py-5 border-b" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
        <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "#6c63ff" }}>
        ...
        <div>
          <p className="text-sm font-semibold text-white leading-tight">Lumière Hotels</p>
          <p className="text-xs" style={{ color: "rgba(255,255,255,0.4)" }}>Admin • Power user</p>
        </div>
      </div>
      ...
      <nav className="flex-1 px-3 py-3 space-y-0.5">
        {NAV.map((item, i) => (
          <div key={i}>
            {item.section && (
              <p className="text-xs font-semibold px-2 pt-4 pb-1.5" style={{ color: "rgba(255,255,255,0.3)", letterSpacing: "0.07em" }}>
                {item.section}
              </p>
            )}
            <div
              className={`flex items-center gap-2.5 px-3 py-2 rounded-xl cursor-pointer transition-all text-sm ${
                item.active ? "text-white font-medium" : "hover:text-white/90"
              }`}
              style={{
                background: item.active ? "#6c63ff" : "transparent",
            ...
            >
              ...
              {item.badge && (
                <span className="text-xs px-1.5 py-0.5 rounded-full" style={{ background: item.active ? "rgba(255,255,255,0.25)" : "rgba(255,255,255,0.15)", color: "#fff" }}>
                  {item.badge}
                </span>
              )}
            </div>
      ...
      <div className="px-3 py-4 border-t" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold text-white flex-shrink-0" style={{ background: "#6c63ff" }}>
            SL
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-white truncate">Sophie Laurent</p>
            <p className="text-xs truncate" style={{ color: "rgba(255,255,255,0.4)" }}>Power user</p>
          </div>
          <svg className="w-4 h-4" style={{ color: "rgba(255,255,255,0.35)" }} fill="none" stroke="currentColor" strokeWidth={1.7} viewBox="0 0 24 24">
