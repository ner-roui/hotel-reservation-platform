...
function NavItem({ active, onClick, label, icon }) {
  return (
    <button
      onClick={onClick}
      className="w-full flex items-center gap-3 px-4 py-2.5 mx-2 rounded-xl transition-all duration-200 text-sm font-medium"
      style={{
...
/* ───────────────── Sidebar ───────────────── */
export default function SidebarEmp({ activeNav, setActiveNav }) {
  return (
        ...
        <button className="text-gray-400 hover:text-gray-600 transition-colors">
          ...
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-9A2.25 2.25 0 002.25 5.25v13.5A2.25 2.25 0 004.5 21h9a2.25 2.25 0 002.25-2.25V15m-3 0l-3-3m0 0l3-3m-3 3H15"
            />
          </svg>
        </button>
      </div>
